...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("fr.uga.laguidonette.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("fr.uga.laguidonette.security.DomainUserDetailsService", "createSpringSecurityUser");
    }
}
