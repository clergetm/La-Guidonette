package fr.uga.laguidonette.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, fr.uga.laguidonette.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, fr.uga.laguidonette.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            createCache(cm, fr.uga.laguidonette.domain.User.class.getName());
