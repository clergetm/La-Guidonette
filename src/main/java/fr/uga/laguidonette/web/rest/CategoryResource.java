...
public class CategoryResource {
    ...
    public Mono<List<Category>> getAllCategories(@RequestParam(required = false, defaultValue = "false") boolean eagerload) {
        log.debug("REST request to get all Categories");
        if (eagerload) {
            return categoryRepository.findAllWithEagerRelationships().collectList();
        } else {
    ...
    public Mono<ResponseEntity<Category>> getCategory(@PathVariable Long id) {
        ...
        Mono<Category> category = categoryRepository.findOneWithEagerRelationships(id);
